...
The rule verifies that each IfcPropertySet starting with Pset_ is defined correctly.
    ...
    Scenario: Agreement on each IfcPropertySet correctly defining an applicable entity.
      ...
      Then The IfcPropertySet must be assigned according to the property set definitions table IFC4X3_ADD2_definitions.csv
      Then Each associated IfcProperty must be named according to the property set definitions table IFC4X3_ADD2_definitions.csv
      Then Each associated IfcProperty must be of type according to the property set definitions table IFC4X3_ADD2_definitions.csv
      Then Each associated IfcProperty value must be of data type according to the property set definitions table IFC4X3_ADD2_definitions.csv