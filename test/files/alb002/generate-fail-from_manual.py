...
def create_fail_scenario05(direction):
    ...
    for alignment_direction in f.by_type("IfcAlignment")[0].IsNestedBy[0].RelatedObjects:
        if alignment_direction.is_a(direction):
            ...
            f.write(f"fail-alb002-scenario05-wrong_alignment_direction_{alignment_direction.is_a()}.ifc")

for direction in directions:
    create_fail_scenario05(direction)
...
def create_fail_scenario04(direction):
    ...
    f.write(f"fail-alb002-scenario04-wrong_element_in_list_{direction}.ifc")
