...
The rule verifies that alignments are nested in accordance with Concept Template 4.1.4.4.1.2
...
Scenario: Agreement on IfcAlignment layout nesting per 4.1.4.4.1.2 for "parent" alignment
...
Scenario: Agreement on IfcAlignment layout nesting per 4.1.4.4.1.2 for "child" alignment
...
Scenario: Alignment aggregation does not go deeper than one level per 4.1.4.4.1.2
